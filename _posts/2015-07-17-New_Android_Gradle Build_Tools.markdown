...
> 原文：[First Look at New Android Gradle 构建工具: The new DSL structure and Gradle 2.5](http://inthecheesefactory.com/blog/new-gradle-build-tools-with-gradle-2.5/en)
